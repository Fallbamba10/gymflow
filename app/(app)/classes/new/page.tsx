    ...
    <div className="max-w-lg">
      ...
      <form action={createClass} className="space-y-5 rounded-md border border-line bg-white shadow-soft p-6">
        ...
        <div className="flex gap-3 pt-2">
          <Link href="/classes" className="flex-1 rounded-md border border-line bg-paper px-4 py-2 text-center text-sm font-medium text-ink hover:bg-white transition-colors">
            Annuler
          </Link>
          <button
            type="submit"
